...
const COLOR_MAP: Record<string, string> = {
  ...
  "коралловый": "#F07B63",
  "персиковый": "#F4B89A",
  "светло-розовый": "#F2C6D0",
  "пыльно-розовый": "#C99A9E",
  "фуксия": "#C2185B",
  "винный": "#5E1A2B",
  "кирпичный": "#A2472F",
};
...
const COLOR_OPTIONS = [
  ...
  "Шоколадный", "Кофейный", "Камель", "Песочный", "Серо-бежевый", "Айвори", "Графитовый", "Оливковый", "Салатовый", "Бирюзовый", "Джинсовый", "Индиго", "Коралловый", "Персиковый", "Светло-розовый", "Пыльно-розовый", "Фуксия", "Винный", "Кирпичный",
];
