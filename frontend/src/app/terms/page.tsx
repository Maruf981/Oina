      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "60px 20px" }}>
        ...
        {lang === "ru" ? (
          <div style={{ display: "flex", flexDirection: "column", gap: 24, color: "var(--text-muted)", fontSize: 14, lineHeight: 1.7 }}>
            <p>
              Используя сайт T.oina.tj, вы соглашаетесь с настоящими условиями. Если вы не согласны
            ...
            <section>
              ...
              <p>
                T.oina.tj прилагает все усилия для точного отображения товаров, однако цвет и внешний
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24, color: "var(--text-muted)", fontSize: 14, lineHeight: 1.7 }}>
            <p>
              Бо истифодаи сайти T.oina.tj, шумо бо ин шартҳо розӣ мешавед. Агар шумо бо ягон банд
            ...
            <section>
              ...
              <p>
                T.oina.tj ҳама кӯшишро ба харҷ медиҳад, то молҳоро дуруст нишон диҳад, аммо ранг ва
