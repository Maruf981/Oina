        ...
        {lang === "ru" ? (
          <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            <section>
              ...
              <p style={{ color: "var(--text-muted)", fontSize: 14, lineHeight: 1.7 }}>
                Мы доставляем по всему Таджикистану. По Душанбе доставка занимает 1–2 дня.
                За пределы Душанбе заказ отправляется через такси-службы за счёт клиента —
                стоимость проезда оплачивается получателем при отправке.
              </p>
            </section>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            <section>
              ...
              <p style={{ color: "var(--text-muted)", fontSize: 14, lineHeight: 1.7 }}>
                Мо ба тамоми Тоҷикистон мерасонем. Дар доираи Душанбе расонидан 1–2 рӯз мегирад.
                Берун аз Душанбе фармоиш тавассути хидматҳои такси бо ҳисоби мизоҷ фиристода мешавад —
                арзиши сафар аз ҷониби қабулкунанда ҳангоми фиристодан пардохт мешавад.
              </p>
            </section>
