...
export default function BestsellersPage() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/products/?sort=popularity&limit=20`)
      .then((res) => res.json())
    ...
    <div className="fv-root">
      ...
      <div className="fv">
        <div className="sec-head fv-head">
          ...
          <div className="ck-eyebrow">{tr("Самые популярные вещи сезона", "Маъмултарин либосҳои мавсим")}</div>
          <h1 className="sec-title fv-title">{tr("Хиты продаж", "Хитҳои фурӯш")}</h1>
          {!loading && (
        ...
        {loading ? (
          ...
          <div className="ck-empty">
            <p>{filter === "brand" ? tr("Брендовых товаров пока нет", "Ҳоло моли брендӣ нест") : tr("Хитов продаж пока нет", "Ҳоло хитҳои фурӯш нест")}</p>
