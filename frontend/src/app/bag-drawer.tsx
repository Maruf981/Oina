...
export function BagDrawerHost() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      setError(msg.includes("В наличии только") || msg.includes("снят с продажи") || msg.toLowerCase().includes("промокод") ? msg : tr("Ошибка оформления заказа. Попробуйте ещё раз.", "Хатогӣ ҳангоми фармоиш. Бори дигар кӯшиш кунед."));
    } finally {
      setPlacing(false);
    }
  };
