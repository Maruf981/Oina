...
const faqItemsRu = [
  ...
  },
  {
    ...
    a: "По всему Таджикистану. Доставка за пределы Душанбе осуществляется через такси-службы за счёт клиента.",
  },
  {
    q: "Сколько времени занимает доставка?",
    a: "Обычно 1–2 дня с момента подтверждения заказа.",
  },
  {
  ...
  },
  {
    ...
    a: "Эта функция скоро появится — вы сможете указать два размера при заказе, курьер привезёт оба, и вы оставите себе подходящий.",
  },
];
...
const faqItemsTj = [
  {
    ...
    a: "Молро, андоза ва рангро интихоб кунед, ба сабад илова кунед ва фармоишро бо суроға ва телефон пур кунед.",
  },
  {
    q: "Кадом усулҳои пардохт мавҷуданд?",
    a: "Пардохт бо корт ё тавассути QR-код мустақиман дар сайт ҳангоми фармоиш.",
  },
  {
    q: "Ба кадом шаҳрҳо расонида мешавад?",
    a: "Ба тамоми Тоҷикистон. Расонидан берун аз Душанбе тавассути хидматҳои такси бо ҳисоби мизоҷ анҷом дода мешавад.",
  },
  {
    q: "Расонидан чанд вақт мегирад?",
    a: "Одатан 1–2 рӯз пас аз тасдиқи фармоиш.",
  },
  {
  ...
  },
  {
    ...
    a: "Ин хусусият ба зудӣ пайдо мешавад — шумо метавонед ҳангоми фармоиш ду андозаро нишон диҳед, курьер ҳарду оварда медиҳад, шумо мувофиқашро нигоҳ медоред.",
  },
];
