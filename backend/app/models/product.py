...
class Product(Base):
    ...
    product_type_ru: Mapped[str | None] = mapped_column(String(100), nullable=True)
    product_type_tj: Mapped[str | None] = mapped_column(String(100), nullable=True)
    fit_ru: Mapped[str | None] = mapped_column(String(100), nullable=True)
    fit_tj: Mapped[str | None] = mapped_column(String(100), nullable=True)
    style_ru: Mapped[str | None] = mapped_column(String(100), nullable=True)
    style_tj: Mapped[str | None] = mapped_column(String(100), nullable=True)
    ...
    variants: Mapped[list["ProductVariant"]] = relationship(back_populates="product", cascade="all, delete-orphan", order_by="ProductVariant.id")
